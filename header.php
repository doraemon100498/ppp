                        ...
                        <div class="wrap-inner clearfix">
                            <div id="site-logo" class="clearfix">
                                <div id="site-logo-inner">
                                    <a href="index.php" title="Suchen" class="main-logo">
                                        <h1 style="color:#fff">Blog Channel</h1>
                                    </a>
                                </div>
                            </div><!-- #site-logo -->
                            ...
                            <nav id="main-nav" class="main-nav">
                                <ul id="menu-primary-menu" class="menu">
                                    <li class="menu-item current-menu-item menu-item-has-children"><a href="#">Trang chủ</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="index.html">Trang chủ 1 </a></li>
                                            <li class="menu-item"><a href="home-2.html">Trang chủ 2</a></li>
                                            <li class="menu-item"><a href="home-3.html">Trang chủ 3</a></li>
                                            <li class="menu-item"><a href="home-4.html">Trang chủ 4</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-item">
                                        <a href="#">Giới thiệu </a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="index.html">Giới thiệu 1 </a></li>
                                            <li class="menu-item"><a href="home-2.html">Giới thiệu 2</a></li>
                                            <li class="menu-item"><a href="home-3.html">Giới thiệu 3</a></li>
                                        </ul>
                                    </li>

                                    <li class="menu-item menu-item-has-children"><a href="#">Dịch vụ</a>
                                        <ul class="sub-menu">
                                            <li class="menu-item"><a href="page-add-listing.html">Dịch vụ 1</a></li>
                                            <li class="menu-item"><a href="page-dashboard.html">Dịch vụ 2</a></li>
                                            <li class="menu-item"><a href="page-my-profile.html">Dịch vụ 3</a></li>
                                            <li class="menu-item"><a href="page-edit-profile.html">Dịch vụ 4</a></li>
                                        </ul>
                                    </li>
